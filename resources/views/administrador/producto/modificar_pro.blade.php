...
<div class="col-md-9">
    ...
    <div class="panel panel-default">
        ...
        <form action="{{route('producto.update',$producto->id)}}" method="post">
            ...
            <input type="text" name="descripcion" value="{{$producto->descripcion}}" class="form-control" placeholder="Descripcion" required>
            ...
            <input type="text" name="talla" value="{{$producto->talla}}" class="form-control" placeholder="Tallage" required>
