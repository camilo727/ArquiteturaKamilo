        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="{{route('venta.index')}}" class="nav-link">VENTA</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="{{ route('usuario.index')}}" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> usuarios <span class="badge">39</span></a>
                        <a href="{{ route('producto.index')}}" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> productos <span class="badge">45</span></a>
                        <a href="{{ route('venta.index')}}" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> venta <span class="badge">112</span></a>
                    </div>
