    ...
    <div class="col-9">
        <div class="tab-content" id="v-pills-tabContent">
            ...
            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                ...
                <?php
                for ($i = 0; $i <= 6; $i++) { ?>
                <img src="{{asset('/imagenes/blusa.jpg')}}" alt="">
                $ 50.000 COP
                <a href=""><button type="button" class="btn btn-secondary btn-lg">COMPRA</a></button></a>
                ...
                <?php
                for ($i = 0; $i <= 4; $i++) { ?>
                <img src="{{asset('/imagenes/camisa.jpg')}}" alt="">
                $ 70.000 COP
                <a href=""><button type="button" class="btn btn-secondary btn-lg">COMPRA</a></button></a>
            ...
            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                ...
                <?php
                for ($i = 0; $i <= 6; $i++) { ?>
                <img src="{{asset('/imagenes/falada.jpg')}}" alt="">
                $ 50.000 COP
                <a href=""><button type="button" class="btn btn-secondary btn-lg">COMPRA</a></button></a>
                ...
                <?php
                for ($i = 0; $i <= 4; $i++) { ?>
                <img src="{{asset('/imagenes/shor.jpg')}}" alt="">
                $ 70.000 COP
                <a href="http://localhost/laravel_tienda/public/envio"><button type="button" class="btn btn-secondary btn-lg">COMPRA</a></button></a>
            ...
            <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                ...
                <?php
                for ($i = 0; $i <= 6; $i++) { ?>
                <img src="{{asset('/imagenes/jean.jpg')}}" alt="">
                $ 50.000 COP
                <a href=""><button type="button" class="btn btn-secondary btn-lg">COMPRA</a></button></a>
                ...
                <?php
                for ($i = 0; $i <= 4; $i++) { ?>
                <img src="{{asset('/imagenes/pantalones.jpg')}}" alt="">
                $ 70.000 COP
                <a href=""><button type="button" class="btn btn-secondary btn-lg">COMPRA</a></button></a>
